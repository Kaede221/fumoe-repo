...
const MoeHeader: FC<IMoeHeader> = ({
  ...
  // 获取一些高度之类的东西
  const appHeaderHeight = navInfo.appHeaderHeight;
  const containerHeight = navInfo.appHeaderHeight - navInfo.statusBarHeight;
      ...
      >
        ...
        <View
          ...
          style={{
            ...
            paddingLeft: titleLeft ? (back ? fontSize + 50 + "rpx" : "0") : "0",
          }}
        >
          {back && (
            <Image
